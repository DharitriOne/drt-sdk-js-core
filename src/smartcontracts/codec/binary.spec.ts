...
describe("test binary codec (advanced)", () => {
    it("should encode / decode lists", async () => {
        ...
        let list = new List(new ListType(new AddressType()), [
            new AddressValue(new Address("moa1qyu5wthldzr8wx5c9ucg8kjagg0jfs53s8nr3zpz3hypefsdd8ssfq94h8")),
            new AddressValue(new Address("moa1spyavw0956vq68xj8y4tenjpq2wd5a9p2c6j8gsz7ztyrnpxrruq0yu4wk")),
            new AddressValue(new Address("moa1k2s324ww2g0yj38qn2ch2jwctdy8mnfxep94q9arncc6xecg3xaqhr5l9h")),
        ]);
