...
describe("test native serializer", () => {
    ...
    it("should accept a mix between typed values and regular JavaScript objects", async () => {
        ...
        let a = 42;
        let b = [new Address("moa1dc3yzxxeq69wvf583gw0h67td226gu2ahpk3k50qdgzzym8npltqntt8td")];
    ...
    it("should accept a mix between typed values and regular JavaScript objects (composite, optionals)", async () => {
        ...
        const addressBech32 = "moa1dc3yzxxeq69wvf583gw0h67td226gu2ahpk3k50qdgzzym8npltqntt8td";
    ...
    it("should perform type inference (enums)", async () => {
        ...
        const p2 = {
            name: "Something",
            fields: { 0: "moa1dc3yzxxeq69wvf583gw0h67td226gu2ahpk3k50qdgzzym8npltqntt8td" },
        };
        ...
        assert.deepEqual(typedValues[2].valueOf(), {
            name: "Something",
            fields: [new Address("moa1dc3yzxxeq69wvf583gw0h67td226gu2ahpk3k50qdgzzym8npltqntt8td")],
        });
