import { ContractQueryResponse } from "@dharitri-sdk/network-providers";
...
describe("test smart contract interactor", function () {
    let dummyAddress = new Address("moa1qqqqqqqqqqqqqpgqak8zt22wl2ph4tswtyc39namqx6ysa2sd8ssc7aswp");
    ...
    it("should set transfers (payments) on contract calls (transfer and execute)", async function () {
        let contract = new SmartContract({ address: dummyAddress });
        let dummyFunction = new ContractFunction("dummy");
        let alice = new Address("moa1qyu5wthldzr8wx5c9ucg8kjagg0jfs53s8nr3zpz3hypefsdd8ssfq94h8");
    ...
    it("should create transaction, with ABI, with transfer & execute", async function () {
        ...
        const alice = new Address("moa1qyu5wthldzr8wx5c9ucg8kjagg0jfs53s8nr3zpz3hypefsdd8ssfq94h8");
    ...
    it("should interact with 'answer'", async function () {
        ...
        assert.equal(
            ...
            "d6daa628985856206e6092c147a16aed52ddb63f165a1989b111afb8cb0f05e7",
        );
        ...
        assert.equal(
            transaction.getHash().toString(),
            "51abe9dad96b0214e15c016a3b38aeed98e3693e96de3b7827057c48e7a2ad37",
        );
