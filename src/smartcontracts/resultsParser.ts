import { TransactionDecoder, TransactionMetadata } from "@dharitri-sdk/transaction-decoder/lib/src/transaction.decoder";
...
export class ResultsParser {
    ...
    parseEvent(transactionEvent: ITransactionEvent, eventDefinition: { inputs: IEventInputDefinition[] }): any {
        ...
        // https://github.com/DharitriOne/drt-chain-go/blob/v1.6.18/process/transactionLog/process.go#L159
