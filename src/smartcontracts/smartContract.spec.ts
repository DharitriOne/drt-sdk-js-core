import { TransactionStatus } from "@dharitri-sdk/network-providers";
...
describe("test contract", () => {
    ...
    it("should compute contract address", async () => {
        ...
        assert.equal(firstContractAddress.bech32(), "moa1qqqqqqqqqqqqqpgqhdjjyq8dr7v5yq9tv6v5vt9tfvd00vg7h40qhxc27r");

        let secondContractAddress = SmartContract.computeAddress(owner, 1);
        assert.equal(secondContractAddress.bech32(), "moa1qqqqqqqqqqqqqpgqde8eqjywyu6zlxjxuxqfg5kgtmn3setxh40q5tpk55");
    });
    ...
    it("should deploy", async () => {
        ...
        assert.equal(contract.getAddress().bech32(), "moa1qqqqqqqqqqqqqpgq3ytm9m8dpeud35v3us20vsafp77smqghd8ssc2d5ns");
    ...
    it("should call", async () => {
        ...
        let contract = new SmartContract({
            address: new Address("moa1qqqqqqqqqqqqqpgqak8zt22wl2ph4tswtyc39namqx6ysa2sd8ssc7aswp"),
        });
    ...
    it("should upgrade", async () => {
        ...
        let contract = new SmartContract();
        contract.setAddress(Address.fromBech32("moa1qqqqqqqqqqqqqpgq3ytm9m8dpeud35v3us20vsafp77smqghd8ssc2d5ns"));
    ...
    it("v13 should be stricter than v12 on optional<variadic<type>> (exotic) parameters (since NativeSerializer is used under the hood)", async () => {
        // Related to: https://github.com/DharitriOne/drt-sdk-js-core/issues/435.
        ...
        const callerAddress = Address.fromBech32("moa1qyu5wthldzr8wx5c9ucg8kjagg0jfs53s8nr3zpz3hypefsdd8ssfq94h8");
        const contractAddress = Address.fromBech32("moa1qqqqqqqqqqqqqpgqaxa53w6uk43n6dhyt2la6cd5lyv32qn4396qygxs0x");
