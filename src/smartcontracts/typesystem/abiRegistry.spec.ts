...
describe("test abi registry", () => {
    ...
    it("binary codec correctly decodes perform action result", async () => {
        ...
        assert.deepEqual(
            ...
            `{"name":"SendTransferExecuteRewa","fields":[{"to":{"bech32":"moa1qqqqqqqqqqqqqpgq6qr0w0zzyysklfneh32eqp2cf383zc89d8ssxtssxl","pubkey":"00000000000000000500d006f73c4221216fa679bc559005584c4f1160e569e1"},"rewa_amount":"42","opt_gas_limit":null,"endpoint_name":{"type":"Buffer","data":[97,100,100]},"arguments":[{"type":"Buffer","data":[7]}]}]}`,
        );
