...
describe("test smart contract transactions factory", function () {
    ...
    it("should throw error when args are not of type 'TypedValue'", async function () {
        const sender = Address.fromBech32("moa1qyu5wthldzr8wx5c9ucg8kjagg0jfs53s8nr3zpz3hypefsdd8ssfq94h8");
    ...
    it("should create 'Transaction' for deploy", async function () {
        ...
        assert.equal(transaction.sender, "moa1qyu5wthldzr8wx5c9ucg8kjagg0jfs53s8nr3zpz3hypefsdd8ssfq94h8");
        assert.equal(transaction.receiver, "moa1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqhsx6tv");
    ...
    it("should create 'Transaction' for execute without transfer", async function () {
        const sender = Address.fromBech32("moa1qyu5wthldzr8wx5c9ucg8kjagg0jfs53s8nr3zpz3hypefsdd8ssfq94h8");
        const contract = Address.fromBech32("moa1qqqqqqqqqqqqqpgqhy6nl6zq07rnzry8uyh6rtyq0uzgtk3e69fq9ny2r9");
        const func = "add";
        const gasLimit = 6000000n;
        ...
        assert.equal(transaction.sender, "moa1qyu5wthldzr8wx5c9ucg8kjagg0jfs53s8nr3zpz3hypefsdd8ssfq94h8");
        assert.equal(transaction.receiver, "moa1qqqqqqqqqqqqqpgqhy6nl6zq07rnzry8uyh6rtyq0uzgtk3e69fq9ny2r9");
    ...
    it("should create 'Transaction' for execute and transfer multiple dcdts", async function () {
        const sender = Address.fromBech32("moa1qyu5wthldzr8wx5c9ucg8kjagg0jfs53s8nr3zpz3hypefsdd8ssfq94h8");
        const contract = Address.fromBech32("moa1qqqqqqqqqqqqqpgqak8zt22wl2ph4tswtyc39namqx6ysa2sd8ssc7aswp");
        const func = "add";
        const gasLimit = 6000000n;
        const args = [new U32Value(7)];
        ...
        assert.equal(transaction.sender, "moa1qyu5wthldzr8wx5c9ucg8kjagg0jfs53s8nr3zpz3hypefsdd8ssfq94h8");
        assert.equal(transaction.receiver, "moa1qyu5wthldzr8wx5c9ucg8kjagg0jfs53s8nr3zpz3hypefsdd8ssfq94h8");
    ...
    it("should create 'Transaction' for upgrade, when ABI is available (with fallbacks)", async function () {
        ...
        const sender = Address.fromBech32("moa1qyu5wthldzr8wx5c9ucg8kjagg0jfs53s8nr3zpz3hypefsdd8ssfq94h8");
        const receiver = Address.fromBech32("moa1qqqqqqqqqqqqqpgqhy6nl6zq07rnzry8uyh6rtyq0uzgtk3e69fq9ny2r9");
        const gasLimit = 6000000n;
    ...
    it("should create 'Transaction' for changing owner address", async function () {
        const sender = Address.fromBech32("moa1qyu5wthldzr8wx5c9ucg8kjagg0jfs53s8nr3zpz3hypefsdd8ssfq94h8");
        const contract = Address.fromBech32("moa1qqqqqqqqqqqqqpgqhy6nl6zq07rnzry8uyh6rtyq0uzgtk3e69fq9ny2r9");
        const newOwner = Address.fromBech32("moa1spyavw0956vq68xj8y4tenjpq2wd5a9p2c6j8gsz7ztyrnpxrruq0yu4wk");
