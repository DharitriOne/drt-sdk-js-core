import { ValidatorPublicKey } from "@dharitri-sdk/wallet";
...
describe("test delegation transactions factory", function () {
    ...
    it("should create 'Transaction' for new delegation contract", async function () {
        const sender = Address.fromBech32("moa18s6a06ktr2v6fgxv4ffhauxvptssnaqlds45qgsrucemlwc8rawqevhvh6");
        ...
        assert.equal(transaction.sender, "moa18s6a06ktr2v6fgxv4ffhauxvptssnaqlds45qgsrucemlwc8rawqevhvh6");
    ...
    it("should create 'Transaction' for adding nodes", async function () {
        const sender = Address.fromBech32("moa18s6a06ktr2v6fgxv4ffhauxvptssnaqlds45qgsrucemlwc8rawqevhvh6");
        const delegationContract = Address.fromBech32("moa1qqqqqqqqqqqqqqqpqqqqqqqqqqqqqqqqqqqqqqqqqqqqqtlllllszhvd5g");
        ...
        assert.equal(transaction.sender, "moa18s6a06ktr2v6fgxv4ffhauxvptssnaqlds45qgsrucemlwc8rawqevhvh6");
        assert.equal(transaction.receiver, "moa1qqqqqqqqqqqqqqqpqqqqqqqqqqqqqqqqqqqqqqqqqqqqqtlllllszhvd5g");
        assert.isDefined(transaction.data);
        assert.deepEqual(
            transaction.data,
            Buffer.from(
