 ...
 */
export const CONTRACT_DEPLOY_ADDRESS = "moa1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqhsx6tv";

/**
 * @deprecated Use {@link DELEGATION_MANAGER_SC_ADDRESS_HEX} instead.
 */
export const DELEGATION_MANAGER_SC_ADDRESS = "moa1qqqqqqqqqqqqqqqpqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqylllsjrx4c2";

/**
 * @deprecated Use {@link 000000000000000000010000000000000000000000000000000000000002ffff} instead.
 */
export const DCDT_CONTRACT_ADDRESS = "moa1qqqqqqqqqqqqqqqpqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqzllls29jpxv";
