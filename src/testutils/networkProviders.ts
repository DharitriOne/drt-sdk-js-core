import { ApiNetworkProvider, ProxyNetworkProvider } from "@dharitri-sdk/network-providers";
...
export function createTestnetProvider(): INetworkProvider {
    return new ApiNetworkProvider("https://testnet-api.dharitri.com", { timeout: 5000 });
}
