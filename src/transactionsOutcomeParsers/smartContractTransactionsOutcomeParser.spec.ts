...
describe("test smart contract transactions outcome parser", () => {
    it("parses deploy outcome (minimalistic)", async function () {
        const contract = Address.fromBech32("moa1qqqqqqqqqqqqqpgqqacl85rd0gl2q8wggl8pwcyzcr4fflc5d8ssppnmyz");
        const deployer = Address.fromBech32("moa1qyu5wthldzr8wx5c9ucg8kjagg0jfs53s8nr3zpz3hypefsdd8ssfq94h8");
