...
describe("test transaction events parser", () => {
    ...
    it("parses events (dcdt-safe, deposit)", async function () {
        ...
        assert.deepEqual(parsed, [
            {
                dest_address: Address.fromBech32("moa1wfkv9495dhtt6a9yepxsyu2mlpw2ua333j4cr0qfulpxr4q5nfns6sz0qr"),
                tokens: [
                    {
        ...
        assert.deepEqual(parsed, [
            {
                data: {
                    ...
                    signers: [Address.fromBech32("moa1qyu5wthldzr8wx5c9ucg8kjagg0jfs53s8nr3zpz3hypefsdd8ssfq94h8")],
                },
            },
        ]);
    });
