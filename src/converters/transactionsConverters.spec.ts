...
} from "@dharitri-sdk/network-providers";
        ...
        const transactionOnNetwork = new TransactionOnNetwork({
            ...
            contractResults: new ContractResults([
                new ContractResultItem({
                    ...
                    logs: new TransactionLogsOnNetwork({
                        address: Address.fromBech32("moa1qqqqqqqqqqqqqpgqj8k976l59n7fyth8ujl4as5uyn3twn0ha0ws9pjvgk"),
                        events: [
                            new TransactionEventOnNetwork({
                                address: Address.fromBech32(
                                    "moa1qqqqqqqqqqqqqpgqj8k976l59n7fyth8ujl4as5uyn3twn0ha0ws9pjvgk",
                                ),
                    ...
                    logs: {
                        ...
                        events: [
                            new TransactionEvent({
                                ...
                                topics: [
                                    Address.fromBech32(
                                        "moa1testnlersh4z0wsv8kjx39me4rmnvjkwu8dsaea7ukdvvc9z396qfw237w",
                                    ).getPublicKey(),
